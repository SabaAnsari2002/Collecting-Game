...
class BearGameOverActivity : AppCompatActivity() {
    private lateinit var gameOverMusic: MediaPlayer

    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game_over_bear)
        ...
        val restartButton: Button = findViewById(R.id.restart_button_bear)
    ...
    private fun showExitConfirmationDialog() {
        AlertDialog.Builder(this).apply {
            ...
            setPositiveButton("Yes") { _, _ ->
                val intent = Intent(this@BearGameOverActivity, BearHomeActivity::class.java)
                startActivity(intent)
                finish()
            }
