...
class IceCreamWinActivity : AppCompatActivity() {
    private lateinit var winMusic: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_win_ice_cream)
    ...
    private fun showExitConfirmationDialog() {
        AlertDialog.Builder(this).apply {
            ...
            setPositiveButton("Yes") { _, _ ->
                val intent = Intent(this@IceCreamWinActivity, IceCreamHomeActivity::class.java)
                startActivity(intent)
                finish()
            }
