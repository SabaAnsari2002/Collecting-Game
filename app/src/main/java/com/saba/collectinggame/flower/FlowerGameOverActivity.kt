...
class FlowerGameOverActivity : AppCompatActivity() {
    private lateinit var gameOverMusic: MediaPlayer

    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game_over_flower)
        ...
        val restartButton: Button = findViewById(R.id.restart_button_flower)
    ...
    private fun showExitConfirmationDialog() {
        AlertDialog.Builder(this).apply {
            ...
            setPositiveButton("Yes") { _, _ ->
                val intent = Intent(this@FlowerGameOverActivity, FlowerHomeActivity::class.java)
                startActivity(intent)
                finish()
            }
