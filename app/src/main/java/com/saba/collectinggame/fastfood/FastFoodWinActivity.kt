...
class FastFoodWinActivity : AppCompatActivity() {
    private lateinit var winMusic: MediaPlayer

    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_win_fast_food)
    ...
    private fun showExitConfirmationDialog() {
        AlertDialog.Builder(this).apply {
            ...
            setPositiveButton("Yes") { _, _ ->
                val intent = Intent(this@FastFoodWinActivity, FastFoodHomeActivity::class.java)
                startActivity(intent)
                finish()
            }
