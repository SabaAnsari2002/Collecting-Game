...
class DonutGameOverActivity : AppCompatActivity() {
    private lateinit var gameOverMusic: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game_over_donut)
        ...
        val restartButton: Button = findViewById(R.id.restart_button_donut)
    ...
    private fun showExitConfirmationDialog() {
        AlertDialog.Builder(this).apply {
            ...
            setPositiveButton("Yes") { _, _ ->
                val intent = Intent(this@DonutGameOverActivity, DonutHomeActivity::class.java)
                startActivity(intent)
                finish()
            }
