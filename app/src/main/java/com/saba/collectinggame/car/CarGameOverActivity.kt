...
class CarGameOverActivity : AppCompatActivity() {
    private lateinit var gameOverMusic: MediaPlayer

    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game_over_car)
        ...
        val restartButton: Button = findViewById(R.id.restart_button_car)
    ...
    private fun showExitConfirmationDialog() {
        AlertDialog.Builder(this).apply {
            ...
            setPositiveButton("Yes") { _, _ ->
                val intent = Intent(this@CarGameOverActivity, CarHomeActivity::class.java)
                startActivity(intent)
                finish()
            }
